			...
			<div class="customer_details">
               <h4> |거래처 상세 </h4>
                  <div class="cust_infoDetails">
                     ...
                     <tr class="tr"><th class="th" >거래처명</th><td id="org_name">${customerDTO.cust_name}</td><th class="th">사업자번호/생년월일</th><td id="business_num">${customerDTO.business_num}</td></tr>
                     <tr class="tr"><th class="th">대표자명</th><td>${customerDTO.boss_name}</td><th class="th">대표전화</th><td id="org_tel">${customerDTO.cust_tel}</td></tr>
                     <tr class="tr"><th class="th">업태</th><td>${customerDTO.cust_uptae}</td><th class="th">종목</th><td>${customerDTO.cust_jongmok}</td></tr>
                     <tr class="tr"><th class="th">담당자 이름</th><td>${customerDTO.man_name}</td><th class="th">담당자 전화번호</th><td id="home_tel">${customerDTO.man_tel}</td></tr>
                     <tr class="tr"><th class="th">담당자 이메일</th><td id="org_email">${customerDTO.man_email}</td><th class="th">Fax</th><td>${customerDTO.fax}</td></tr>
			  ...
			  <!-- QR코드 시작-->
			  <input type="button" name="getQr"value="QR코드 생성"><br>

...
<c:forEach var="UnstoreDTO" items="${unstoreDetailList}">
	<tr><th>작업지시번호</th><td>${UnstoreDTO.wo_num }</td><th>납기일</th><td>${UnstoreDTO.out_date }</td><th>작업지시일자</th><td>${UnstoreDTO.wo_date }</td><th>발주담당자 사번</th><td>${UnstoreDTO.wo_emp }</td></tr>
